...
Run
```bash
python3 awx_log_view.py example.log
```
...
Project Structure
- awx_log_view.py: application entrypoint and UI wiring
- log_manager.py: parsing, indexing, filtering, and navigation logic
- kb.py: key bindings and modal dialogs
- ui.py: styles and status/bottom bar rendering
- lexer.py: syntax highlighting for log lines
